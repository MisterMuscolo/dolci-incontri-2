    ...
    <div className="bg-gray-50 p-4 sm:p-6 md:p-8 min-h-screen">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md space-y-4 text-gray-700">
          <p>
            Benvenuto su Dolci Incontri. Utilizzando il nostro sito web, accetti di rispettare i seguenti termini e condizioni d'uso. Ti preghiamo di leggerli attentamente.
          </p>
          ...
          <p>
            Per qualsiasi domanda sui presenti Termini, ti preghiamo di contattarci all'indirizzo <a href="mailto:supporto@dolciincontri.com" className="text-rose-500 hover:underline">supporto@dolciincontri.com</a>.
          </p>
        </div>
      </div>
    </div>
