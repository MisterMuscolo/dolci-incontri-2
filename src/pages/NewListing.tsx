...
const listingSchema = z.object({
  ...
  title: z.string().min(5, 'Il titolo deve avere almeno 5 caratteri.'), // Modificato: min 5, rimosso max
  description: z.string().min(15, 'La descrizione deve avere almeno 15 caratteri.'), // Modificato: min 15, rimosso max
